  ...
  return (
    <main className="min-h-screen bg-slate-950">
      ...
      <div className="max-w-2xl mx-auto px-6 py-12">
        <h1 className="text-2xl font-semibold text-white mb-2">Does this sound right?</h1>
        <p className="text-slate-400 text-sm mb-8">
          We read your idea and classified it. Confirm or adjust before we continue.
        </p>

        <div className="rounded-2xl border border-white/10 bg-slate-900/80 p-6 mb-6">
          <p className="text-xs font-semibold uppercase tracking-wide text-slate-500 mb-1">Your idea</p>
          <p className="text-slate-300 text-sm">{idea.raw_text}</p>
        </div>

        <div className="rounded-2xl border border-indigo-500/20 bg-indigo-500/10 p-6 mb-8">
          <p className="text-xs font-semibold uppercase tracking-wide text-indigo-300 mb-1">
            We read this as
          </p>
          <p className="text-white font-medium mb-3">{idea.restatement}</p>
          <span className="inline-block rounded-full bg-indigo-500/15 text-indigo-300 text-xs font-semibold px-3 py-1">
