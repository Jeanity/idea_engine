...
- summary: { "text": string }
- viability_snapshot: { "scores": { "market_opportunity": { "score": number, "rationale": string }, "execution_difficulty": { "score": number, "rationale": string }, "capital_required": { "score": number, "rationale": string }, "time_to_revenue": { "score": number, "rationale": string } }, "overall_verdict": string, "success_outlook": { "score": number, "rationale": string } }
